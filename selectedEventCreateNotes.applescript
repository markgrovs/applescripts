--set myEvent to get_selected_event()
create_notes(get_selected_event())
on create_notes(myEvent)
	tell application "Calendar"
		set meetingSubject to get summary of myEvent
		set meetingStartTime to get start date of myEvent
		set people to get attendees of myEvent
...
on get_selected_event()
	...
	tell application "Calendar"
		...
		try
			...
			set myEvent to the first event of defCal whose summary is eventName
